# -*- coding: utf-8 -*-
"""
Created on Thu Jan 25 17:47:56 2024
...
similarity_user = pd.read_pickle("C:\\Users\\pawar_d14dnwj\\Downloads\\DS PROJECT\\book deployment\\similarity_user.pkl")
final_ratings = pd.read_excel("C:\\Users\\pawar_d14dnwj\\Downloads\\DS PROJECT\\book deployment\\final_ratings.xlsx")     
...
def recommendations_for_user(user_id):
    ...
    if user_id in similarity_user.columns:
        ...
        return list(recommended_books)[:10]
    else:
        return []
